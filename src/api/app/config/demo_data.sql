...
INSERT INTO "tasks" VALUES(1,NULL,'Prepare UML Diagrams for a project',2,'Use Case, Classes, ER, Deployment and DFD are needed','480','120',NULL);
INSERT INTO "tasks" VALUES(2,NULL,'Describe program business model and processes',1,'A few pages should be enough.',NULL,NULL,NULL);
INSERT INTO "tasks" VALUES(3,NULL,'Configure build system',1,'I recommend using grunt, look for some examples at blabla.com',NULL,NULL,NULL);
