...
INSERT INTO "users" VALUES(2,0,'DrDaemos','daemos','$2y$10$aQAo45HdJgyAlsDZNX3Lxua5EPsyBbILTl1EdjPPs7qUyr31i1E8i',NULL,1,3); --daemos
INSERT INTO "users" VALUES(3,0,'Michael','alive','$2y$10$5wedYLQuY29CAE7uLMar3u1a6kU9FGEei7tSsvKr0NSy11ViniXQq',NULL,1,3); --tolkonemishka
INSERT INTO "users" VALUES(4,1,'Oopsie','deleted','$2y$10$MJ5yrE7owbqNfjLk5oSg4etFlfe7kqsBT7Bx9pLHwxdqZKKoZ5AkW',NULL,0,1); --deleted
INSERT INTO "users_roles" VALUES(1,'Registered');
INSERT INTO "users_roles" VALUES(2,'Project Manager');
INSERT INTO "users_roles" VALUES(3,'Developer');
...
INSERT INTO "tasks" VALUES(3,NULL,'Configure build system',1,3,'I recommend using grunt, look for some examples at blabla.com',NULL,NULL,NULL);
